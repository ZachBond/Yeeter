...
//                    Player info = null;
//                    info = sysmgr.FindByID(int.Parse(pid));
//                    if (info == null)
//                    {
...
//                        Name.Text = info.FirstandLast; //NOT NULL in Database
...
//                    item.FirstName = Name.Text.Trim(); //NOT NULL in Database
//                    if (PlayerList.SelectedValue == "0") //NULL in Database
//                    {
//                        item.PlayerID = null;
//                    }
//                    else
//                    {
//                        item.PlayerID = int.Parse(PlayerList.SelectedValue);
//                    }
...
//                    item.FirstName = Name.Text.Trim();
//                    if (PlayerList.SelectedValue == "0")
//                    {
//                        item.PlayerID = null;
//                    }
//                    else
...
//                    }
//                    item.PlayerID = int.Parse(PlayerList.SelectedValue);
//                    item.Age = decimal.Parse(Age.Text);
